...
/**
 * Created by bobby.peng on 2017/2/4.
 */
public class LRUCache {
    static {
        //DO TEST
        GlobalConstants.METHOD_PARAM_TYPE_MAP.put("com.bobby.peng.com.bobby.peng.learning.java.leetcode.LRUCache.get", new Class[]{int.class});
        GlobalConstants.METHOD_PARAM_TYPE_MAP.put("com.bobby.peng.com.bobby.peng.learning.java.leetcode.LRUCache.put", new Class[]{int.class, int.class});
        GlobalConstants.CONSTRUCT_PARAM_TYPE_MAP.put("com.bobby.peng.com.bobby.peng.learning.java.leetcode.LRUCache.LRUCache", new Class[]{int.class});
    }
...
//        lfuCache.get(0);
        ...
        try {
            MethodAndPropUtils.parseMethodAndPropUtils(LRUCache.class, methodAndProps);
